...
Follow the link:kvm-host-configuration-and-preparation-checklist.html[host preparation checklist], and review the required information for the link:reference_chk_deploy_req_info.html[deploy utility installation] and the link:reference_chk_select_req_info.html[ONTAP Select installation] for more information.
