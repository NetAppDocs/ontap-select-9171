...
* FlexCache
+
There are limitations to the support for FlexCache write-back with ONTAP Select. For more information, refer to link:https://docs.netapp.com/us-en/ontap-select/concept_ots_overview.html#flexcache-write-back-with-ontap-select[FlexCache write-back with ONTAP Select^].
* FlexClone
* iSCSI
* NDMP
...
* SnapLock Select
+
SnapLock Select is the implementation of ONTAP SnapLock designed for ONTAP Select and includes SnapLock Enterprise. It does not include SnapLock Compliance. 
+
Learn about link:https://docs.netapp.com/us-en/ontap/snaplock/index.html[ONTAP SnapLock^]
* SnapMirror
* SnapRestore
* SnapVault
...
* SnapMirror cloud
+
You need to link:https://mysupport.netapp.com/site/help[open a non-technical support case^] to obtain a SnapMirror cloud license.
+
Learn about link:https://docs.netapp.com/us-en/ontap/concepts/snapmirror-cloud-backups-object-store-concept.html[SnapMirror cloud backups to object storage^]

[NOTE]
====
* For ONTAP Select 9.16.1 and earlier, SnapLock Select (including tamperproof snapshot locking) is available from the link:https://mysupport.netapp.com/site/[NetApp Support Site^].
...
* link:concept_ots_overview.html#compare-ontap-select-and-ontap-9[Comparing ONTAP Select and ONTAP 9]
