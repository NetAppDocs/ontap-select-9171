...
summary: Beginning with ONTAP Select 9.15.1, you can increase or decrease the size of an existing cluster.
---
= Expand or contract an ONTAP Select cluster on ESXi or KVM host
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
* Red Hat Enterprise Linux (RHEL) 64-bit 10.1, 10.0, 9.7, 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0, 8.8, 8.7, and 8.6
* Rocky Linux 10.1, 10.0, 9.7, 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0, 8.9, 8.8, 8.7, and 8.6
...
.After you finish
link:task_cli_clusters.html[Back up the ONTAP Select Deploy configuration data].
