...
*Note*: There are software RAID workflow limitations for KVM hypervisors on RHEL 10.0 and Rocky Linux 10.0 hosts. For more information, see the following Knowledge Base articles:
