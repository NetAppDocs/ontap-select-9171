...
*Note*: There are software RAID workflow limitations for KVM hypervisors on RHEL and Rocky Linux 10.1 and 10.0 hosts. For more information, see the following Knowledge Base articles:
