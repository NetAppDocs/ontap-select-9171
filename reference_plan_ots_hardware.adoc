...
[NOTE]
You should review the link:reference_release_notes.html[ONTAP Select Release Notes] for any additional known restrictions or limitations.
...
* KVM on Red Hat Enterprise Linux (RHEL) 10.0, 9.6, 9.5, 9.4, 9.2, 9.1, 9.0, 8.8, 8.7, and 8.6
* KVM on Rocky Linux 10.0, 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0, 8.9, 8.8, 8.7, and 8.6 
